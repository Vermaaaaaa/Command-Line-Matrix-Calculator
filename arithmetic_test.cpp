...
int main(){
    Matrix mat1(2,2), mat2(2,2), mat3(3,2), mat4(2,2), mat5(5,5);
    ...
    mat4 = multiply3(mat1,mat2);

    

    assert(mat4.get_index(0, 0) == 30);
    assert(mat4.get_index(0, 1) == 28);
    assert(mat4.get_index(1, 0) == 66);
    assert(mat4.get_index(1, 1) == 64);
